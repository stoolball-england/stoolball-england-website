...
abstract class Statistic
{
    ...
    private $supports_filter_by_fielder = false;
    ...
    /**
     * Sets whether this statistic can be filtered by fielder
     */
    protected function SetSupportsFilterByFielder($supported) {
        $this->supports_filter_by_fielder = (bool)$supported;
    }
    
    /**
     * Gets whether this statistic can be filtered by fielder
     */
    public function SupportsFilterByFielder() {
        return $this->supports_filter_by_fielder;
    }
