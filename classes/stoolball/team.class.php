...
class Team implements IHasShortUrl
{
	...
	public static function GetShortUrlFormatForType(SiteSettings $settings)
	{
		...
		'{0}/matches/friendlies/add' => $settings->GetUrl('MatchAddFriendlyToTeam'),
		'{0}/matches/league/add' => $settings->GetUrl('MatchAddLeagueToTeam'),
		'{0}/matches/cup/add' => $settings->GetUrl('MatchAddCupToTeam'),
		'{0}/matches/practices/add' => $settings->GetUrl('MatchAddPracticeToTeam'),
