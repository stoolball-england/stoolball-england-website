<?php
		...
		$this->statistics["most_wickets"] = $statistics_manager->ReadBestPlayerAggregate("wickets", true);
		...
		$this->statistics["most_catches"] = $statistics_manager->ReadBestPlayerAggregate("catches", true);
		$this->statistics["most_run_outs"] = $statistics_manager->ReadBestPlayerAggregate("run_outs", true);
