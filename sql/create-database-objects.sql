...
CREATE TABLE IF NOT EXISTS `nsa_batting` (
  ...
  `runs` INT(3) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nsa_ground` (
  ...
  `paon` VARCHAR(100) NULL DEFAULT NULL,
  `street_descriptor` VARCHAR(100) NULL DEFAULT NULL,
  `locality` VARCHAR(35) NULL DEFAULT NULL,
  `town` VARCHAR(30) NULL DEFAULT NULL,
  `administrative_area` VARCHAR(30) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nsa_player_match` (
  ...
  `won_match` TINYINT(1) NULL DEFAULT NULL,
  ...
  `runs_scored` SMALLINT(3) UNSIGNED NULL DEFAULT NULL,
  `balls_faced` TINYINT(3) UNSIGNED NULL DEFAULT NULL,
